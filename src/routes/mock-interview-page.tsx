    ...
    return (
        <div className="flex flex-col w-full gap-8 py-5">
            ...
            <div className="w-full">
                <Alert className="bg-indigo-50 border border-indigo-100 p-6 rounded-lg flex items-start gap-4">
                    <div className="flex flex-col w-full">
                        ...
                        <AlertDescription className="text-indigo-800 mb-4">
                            Press the <strong>Record Answer</strong> button to begin answering your interview question. Take your time and speak clearly.
                        </AlertDescription>

                        <div className="bg-white bg-opacity-70 p-4 rounded-md border border-indigo-100 mb-4">
                            <div className="flex items-center gap-2 mb-1">
                                <Video className="h-4 w-4 text-indigo-700" />
                                <span className="font-medium text-indigo-900">Privacy Guarantee</span>
                            </div>
